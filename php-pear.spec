...
* Thu Jun  1 2017 Remi Collet <remi@fedoraproject.org> 1:1.10.4-1
- initial package for rh-php71 in RHSCL-3.0

* Fri Sep  9 2016 Remi Collet <remi@fedoraproject.org> 1:1.10.1-3
...
* Thu Jul 21 2016 Remi Collet <rcollet@redhat.com> 1:1.10.1-1
- update PEAR to 1.10.1 for PHP 7 and RHSCL 2.3
- update Archive_Tar to 1.4.2
- update Console_Getopt to 1.4.1
- update Structures_Graph to 1.1.1
- update XML_Util to 1.3.0
- add PEAR_Manpages to 1.10.0
